...
Pod::Spec.new do |s|
  ...
  s.source                  = { :http => 'https://github.com/realm/realm-swift/releases/download/v20.0.4/Carthage.xcframework.zip' }
  s.author                  = { 'Realm' => 'realm-help@mongodb.com' }
  s.library                 = 'c++', 'z', 'compression'
  s.requires_arc            = true
  s.social_media_url        = 'https://twitter.com/realm'
  s.documentation_url       = "https://www.mongodb.com/docs/atlas/device-sdks/sdk/swift/"
